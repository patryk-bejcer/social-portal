            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{url('/event/' . $event->id . '/edit')}}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                                ...
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="col-md-8 no-padding">
                                        <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                                            ...
                                            <input name="website" id="title" type="url" class="form-control"  value="{{ $event->website }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                                        ...
                                        <input id="place" type="text" class="form-control" name="place" value="{{ $event->place }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                                        ...
                                        <textarea name="description" class="form-control" placeholder="Krótki opis wydarzenia"  style="width: 100%" name="" id="" rows="3">{{ $event->description }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1">
                                    <button type="submit" class="btn btn-primary btn-sm pull-right">Aktualizuj wydarzenie</button>
                                </div>
                            </div>
                        </form>
                    </div>
